...
open class YPImagePicker: UINavigationController {
  ...
  public var callBackDelegate: PermissionDeniedCallBack? = nil
...
extension YPImagePicker: PermissionDeniedCallBack {
  public func onCancelClick() {
    callBackDelegate?.onCancelClick()
  }
}
